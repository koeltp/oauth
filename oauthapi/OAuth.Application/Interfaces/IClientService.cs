...
public interface IClientService
{
    ...
    Task<(Client Client, string ClientSecret)> CreateAsync(string name, string? description, string? logo, string redirectUris, string allowedScopes, Guid? userId = null, bool isPublic = false);
